...
export const ProductDetail = () => {
  ...
  return (
    <div className="container">
      <h3 className="text-primary-emphasis m-3">Product Detail</h3>
      ...
      <h3 className="text-primary-emphasis m-3">Related Products</h3>
          ...
          <div className="card" key={product.id}>
            ...
            <div className="card-body text-center">
              <h5 className="card-title">
                <Link className="text-decoration-none text-dark" to={`/product/${product.id}`}>{product.productName}</Link>
              </h5>
